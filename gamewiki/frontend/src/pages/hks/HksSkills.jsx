      ...
      <main className="hk-container">
        <section className="hk-hero">
          <div className="hk-hero-content">
            <h1 className="red-glow">Шёлковые Умения</h1>
            <p className="silver-text">Уникальные боевые техники, использующие шелковую магию</p>
          </div>
        </section>
        <HksNavigation />
        <section className="hk-content-section">
          <div className="hk-coming-soon">
            ...
            <p>Скоро здесь появится информация о шелковых умениях</p>
          </div>
        </section>
      </main>
      <footer className="hk-footer">
        <p>Hollow Knight: Silksong • Шёлковые Умения</p>
      </footer>
    </>
  );
};
export default HksSkills;