      ...
      <main className="hk-container">
        <section className="hk-hero">
          <div className="hk-hero-content">
            <h1 className="red-glow">Способности</h1>
            <p className="silver-text">Основные боевые и исследовательские умения Хорнет</p>
          </div>
        </section>
        <HksNavigation />
        <section className="hk-content-section">
          <div className="hk-coming-soon">
            ...
            <p>Скоро здесь появится информация о способностях</p>
          </div>
        </section>
      </main>
      <footer className="hk-footer">
        <p>Hollow Knight: Silksong • Способности</p>
      </footer>
    </>
  );
};
export default HksAbilities;